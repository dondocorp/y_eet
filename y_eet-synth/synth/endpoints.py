...
from .client import RequestRecord, SynthClient
from .payloads import (
    create_session_payload,
    deposit_payload,
    place_bet_payload,
    risk_evaluate_payload,
    risk_signal_payload,
    settle_bet_payload,
    withdraw_payload,
)
...
async def wallet_balance(
    ...
    return await client.request(
        "GET",
        f"/api/v1/wallet/{user_id}/balance",
        token=token,
...
async def wallet_transactions(
    ...
    return await client.request(
        "GET",
        f"/api/v1/wallet/{user_id}/transactions",
        token=token,
        params=params,
...
async def wallet_deposit(
    ...
    return await client.request(
        "POST",
        f"/api/v1/wallet/{user_id}/deposit",
        token=token,
...
async def wallet_withdraw(
    ...
    return await client.request(
        "POST",
        f"/api/v1/wallet/{user_id}/withdraw",
        token=token,
        idempotency_key=idempotency_key or str(uuid.uuid4()),
        json=payload,
...
async def game_session_get(
    ...
    return await client.request(
        "GET",
        f"/api/v1/games/sessions/{session_id}",
        token=token,
...
async def game_session_heartbeat(
    ...
    return await client.request(
        "POST",
        f"/api/v1/games/sessions/{session_id}/heartbeat",
        token=token,
...
async def game_session_close(
    ...
    return await client.request(
        "POST",
        f"/api/v1/games/sessions/{session_id}/close",
        token=token,
...
async def risk_score(
    ...
    return await client.request(
        "GET",
        f"/api/v1/risk/users/{user_id}/risk-score",
        token=token,
...
async def config_flag(client: SynthClient, token: str, flag_key: str) -> RequestRecord:
    return await client.request(
        "GET",
        f"/api/v1/config/flags/{flag_key}",
        token=token,
...
async def health_ready(client: SynthClient) -> RequestRecord:
    return await client.request(
        "GET", "/health/ready", endpoint_name="GET /health/ready"
    )
